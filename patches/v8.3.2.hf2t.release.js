(()=>{
 const VERSION='8.3.2-HF2T-PERF',REV='832perf1';
 const tags=`
...
<script src="./patches/v8.3.2.hf2b.bootstrap.js?v=${REV}" data-deen-hf2t-avatar><\/script>
<script src="./patches/v8.3.2.hf2k.closet.js?v=${REV}" data-deen-hf2t-closet><\/script>
<script src="./patches/v8.3.2.hf2s.runtime.js?v=${REV}" data-deen-hf2t-fit-base><\/script>
<script src="./patches/v8.3.2.hf2t.runtime.js?v=${REV}" data-deen-hf2t-runtime><\/script>
`;
 window.DEEN_PATCH_V832HF2T=function(html){let out=String(html);if(out.includes('data-deen-hf2t-runtime'))return{html:out,version:VERSION,applied:0};out+=tags;return{html:out,version:VERSION,applied:1}};
})();
