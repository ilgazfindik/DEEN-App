(()=>{
 ...
 const VERSION='8.3.9-HF2U-FACE-SAFE';
 ...
 window.DEEN_HF2U={version:VERSION,refresh:schedule,check:()=>({version:VERSION,gender:gender(),active:activeId(),outfit:!!$('.v832u-outfit',mannequin()),faceSafe:!!window.DEEN_V839_ACTIVE,saveLocked:true,eventDriven:true})};
})();
